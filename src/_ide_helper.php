...
namespace {
    ...
    class HyperfEloquent extends \Hyperf\DbConnection\Model\Model
    {
        /**
         ...
         * @param mixed $value
         * @param string $boolean
         * @return \Hyperf\DbConnection\Model\Model|static
         * @static
         */
         ...
         * @param mixed $id
         * @param array $columns
         * @return \Hyperf\DbConnection\Model\Model|Collection|static[]|static|null
         * @static
         */
         ...
         * @param mixed $id
         * @param array $columns
         * @return \Hyperf\DbConnection\Model\Model|Collection|static|static[]
         * @static
         */
         ...
         * @param array $columns
         * @return \Hyperf\DbConnection\Model\Model|static
         * @throws \Hyperf\DbConnection\Model\ModelNotFoundException
         * @static
         */
         ...
         * @return \Hyperf\DbConnection\Model\Model|static|mixed
         * @static
         */
         ...
         *
         * @param array $attributes
         * @return \Hyperf\DbConnection\Model\Model|$this
         * @static
         */
         ...
         *
         * @param array|string $columns
         * @return \Hyperf\DbConnection\Model\Model|object|static|null
         * @static
         */
         ...
         *
         * @param \Closure|Builder|\Illuminate\Database\Query\Expression|string $column
